...
{
    // Using the same criteria as compareStore,
...
{
    // Using the insertion sort algorithm, sort s
...
void sortUsingPtrs(vector<Store>& stores, bool comp(const Store*, const Store*))
{
    ...
    // Create a vector of Store pointers, and set each pointer
    ...
    // Using the now-sorted vector of pointers, replace each Store
